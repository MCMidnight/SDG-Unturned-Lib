...
namespace SDG.Unturned
{
	...
	{
		// Token: 0x06003D01 RID: 15617 RVA: 0x00122A9C File Offset: 0x00120C9C
		...
		// Token: 0x06003D02 RID: 15618 RVA: 0x00122AC9 File Offset: 0x00120CC9
		...
		// Token: 0x06003D03 RID: 15619 RVA: 0x00122AFC File Offset: 0x00120CFC
		public static Transform getBarricade(Transform parent, byte hp, ulong owner, ulong group, Vector3 pos, Quaternion rot, ushort id, byte[] state, ItemBarricadeAsset asset)
		{
			if (asset != null)
			{
				...
				bool useWaterHeightTransparentSort = asset.useWaterHeightTransparentSort;
				transform.name = id.ToString();
